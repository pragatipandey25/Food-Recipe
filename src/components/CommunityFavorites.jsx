...
import { getCommunityFavorites } from "../utils/store";
...
const CommunityFavorites = () => {
  ...
  if (!list || list.length === 0)
    return (
      <section className="p-4">
        <h3 className="text-2xl font-semibold mb-2">Community Favorites</h3>
        <p className="text-muted">
          No community favorites yet. Encourage users to add favorites!
        </p>
      </section>
    );
  ...
  return (
    <section className="p-4">
      <h3 className="text-2xl font-semibold mb-4">Community Favorites</h3>
